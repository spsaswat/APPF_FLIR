...
def apply_transformations_on_images(image_folder, transformation_folder, output_folder):
    ...
    for file_name in os.listdir(image_folder):
        ...
        if match:
            ...
            aligned_image_path = os.path.join(output_folder, f'aligned_detected_{image_type}_{suffix}.png')
...
if __name__ == "__main__":
    ...
    transformation_folder = "SensorCommunication/Acquisition/batch_1/test_plant_20240903102437/"
